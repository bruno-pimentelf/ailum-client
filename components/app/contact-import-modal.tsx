      ...
      {open && (
        <>
          ...
          <motion.div
            ...
            className="fixed inset-x-4 top-[8vh] z-50 mx-auto max-h-[84vh] w-full max-w-4xl overflow-hidden rounded-2xl border border-border/60 bg-overlay shadow-2xl shadow-foreground/10"
          >
